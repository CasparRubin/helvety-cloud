-- Delete flows: project wraps on workspace wipe, membership leave/transfer/remove,
-- comments.author_id SET NULL for account delete.
...
-- comments.author_id: allow account delete after soft-leaving shared workspaces
