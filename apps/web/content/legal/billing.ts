...
export const billingDoc: LegalDocument = {
  slug: "billing",
  title: "Billing terms",
  versionLabel: "2026-07-28-v9",
  sections: [
    {
      heading: "Status",
      paragraphs: [
        "Helvety Cloud offers a free plan and a paid Pro Workspace plan per workspace, processed through Stripe, plus an optional Capacity Increase add-on that raises all paid limits together. Nothing is charged unless a workspace member explicitly starts Checkout (where the price is shown before any charge) or changes paid add-ons.",
    ...
    },
    {
      heading: "Free plan",
      paragraphs: [
        "The free plan applies fair-use limits per workspace (for example counts of projects, members, tasks per project, notes, contacts, and comments and replies). File uploads and document storage are not available on the free plan, including in free Personal workspaces. Current limits are shown in the product where they apply, before a limit blocks an action, not after payment.",
        "Each account may have one free-tier workspace attributed to it (typically the Personal workspace). Additional workspaces attributed to the account require Pro Workspace access for that workspace.",
    ...
    },
    {
      ...
      paragraphs: [
        "Subscriptions are workspace-scoped: any member may manage that workspace’s Pro Workspace plan and add-ons. Leaving a Pro workspace does not cancel billing.",
        ...
        "Capacity Increase adds one extra bundle of capacity each time you buy it. Each pack adds 10 projects, 500 tasks per project, 250 notes, 250 contacts, 500 comments and replies, 10 members, and 2.5 GiB encrypted file storage. Capacity Increase requires an active Pro Workspace subscription on that workspace.",
