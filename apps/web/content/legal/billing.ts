  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "If a paid or complimentary Pro workspace ends and you would then own more than two free-tier workspaces, Helvety may soft-lock the overflow workspace(s): existing vault content stays available to open, edit, download, export, and delete, but creating new resources in that workspace is paused until you upgrade it to Pro or reduce owned free workspaces back within the allowance. Helvety does not delete ciphertext or withhold wrapped keys solely because a workspace is soft-locked.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "You may cancel renewal at any time in the Stripe billing portal (available from workspace billing settings); access to paid limits continues through the paid period already purchased unless stated otherwise. No cancellation fees, no retention tricks. Complimentary access may be revoked by Helvety; vault ciphertext is not deleted solely because a complimentary grant ends — free limits and, where applicable, soft-lock create gates may then apply.",
