  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "Workspace owners may redeem a discount or complimentary code issued by Helvety. A 100% complimentary code grants Pro Workspace access for that workspace without collecting a payment method. Partial discount codes reduce the price of Pro Workspace and paid add-ons for that workspace when Checkout or billing updates run through Stripe.",
