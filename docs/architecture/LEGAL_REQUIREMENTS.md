...
| **Privacy Policy** | `/legal/privacy` | Controller; account vs vault ciphertext; processors; rights; transfers |
| **Acceptable Use Policy** | `/legal/aup` | Illegal content, abuse; enforcement without reading vault |
| **E2EE / zero-access notice** | `/legal/e2ee` | No decrypt; no recovery; lost keys = permanent loss |
| **Billing terms** | `/legal/billing` | Free use now; paid plans when enabled; Stripe never sees vault plaintext |
